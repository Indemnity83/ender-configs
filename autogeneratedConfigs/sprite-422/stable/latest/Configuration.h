...
#define STRING_CONFIG_H_AUTHOR "u/minist3r, u/indemnity83" //ORIGINAL: #define STRING_CONFIG_H_AUTHOR "(none, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro w/ CRTouch and Sprite" //ORIGINAL: #define CUSTOM_MACHINE_NAME "Ender-3 Pro V1.5"
