...
#define STRING_CONFIG_H_AUTHOR "u/indemnity83" //ORIGINAL: #define STRING_CONFIG_H_AUTHOR "(Neil McNeight, Stock)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro Dragon Forge" //ORIGINAL: #define CUSTOM_MACHINE_NAME "Ender-3 Pro V1.5 (4.2.2)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.5, -40, -2.07 } //ORIGINAL: #define NOZZLE_TO_PROBE_OFFSET { 44, -6, -2.35 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
