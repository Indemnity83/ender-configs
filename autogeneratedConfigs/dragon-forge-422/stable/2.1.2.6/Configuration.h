...
#define X_MIN_POS 5 //ORIGINAL: #define X_MIN_POS 0
#define Y_MIN_POS -6 //ORIGINAL: #define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 225 //ORIGINAL: #define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS 214 //ORIGINAL: #define Y_MAX_POS Y_BED_SIZE
