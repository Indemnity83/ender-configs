...
#define Y_BED_SIZE 208 //ORIGINAL: #define Y_BED_SIZE 235

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 12 //ORIGINAL: #define X_MIN_POS 0
#define Y_MIN_POS 22 //ORIGINAL: #define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 244 //ORIGINAL: #define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS 230 //ORIGINAL: #define Y_MAX_POS Y_BED_SIZE
