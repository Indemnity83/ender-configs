...
#define ASSISTED_TRAMMING //ORIGINAL: //#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY {{20.6, 30}, {160.6, 30}, {170.6, 160}, {20.6, 170}} //ORIGINAL:   #define TRAMMING_POINT_XY { {  20, 20 }, { 180,  20 }, { 180, 180 }, { 20, 180 } }
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT 10 //ORIGINAL:   //#define PROBING_MARGIN_LEFT PROBING_MARGIN
  #define PROBING_MARGIN_RIGHT 26 //ORIGINAL:   //#define PROBING_MARGIN_RIGHT PROBING_MARGIN
  #define PROBING_MARGIN_FRONT 10 //ORIGINAL:   //#define PROBING_MARGIN_FRONT PROBING_MARGIN
  #define PROBING_MARGIN_BACK 45 //ORIGINAL:   //#define PROBING_MARGIN_BACK PROBING_MARGIN
#endif
...
#define ADVANCED_PAUSE_FEATURE //ORIGINAL: //#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH 60 //ORIGINAL:   #define FILAMENT_CHANGE_UNLOAD_LENGTH      100  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH 40 //ORIGINAL:   #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     0  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define HOME_BEFORE_FILAMENT_CHANGE //ORIGINAL:   //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change
