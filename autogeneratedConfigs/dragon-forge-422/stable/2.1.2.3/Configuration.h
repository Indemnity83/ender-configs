...
#define STRING_CONFIG_H_AUTHOR "u/indemnity83" //ORIGINAL: #define STRING_CONFIG_H_AUTHOR "(none, default config)" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 16.62 //ORIGINAL:     #define DEFAULT_Kp  28.72
    #define DEFAULT_Ki 1.33 //ORIGINAL:     #define DEFAULT_Ki   2.62
    #define DEFAULT_Kd 51.85 //ORIGINAL:     #define DEFAULT_Kd  78.81
  #endif
#else
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.5, -40, -2.07 } //ORIGINAL: #define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 0 //ORIGINAL: #define PROBING_MARGIN 10
...
#define Z_PROBE_OFFSET_RANGE_MIN -20 //ORIGINAL: #define Z_PROBE_OFFSET_RANGE_MIN -10
#define Z_PROBE_OFFSET_RANGE_MAX 20 //ORIGINAL: #define Z_PROBE_OFFSET_RANGE_MAX 10
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 260 //ORIGINAL: #define X_MAX_POS X_BED_SIZE
